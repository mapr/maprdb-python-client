...
class JsonValueTest(unittest.TestCase):
    ...
    def test_create_type_json_value(self):
        json_value = JsonValue(value_type=ValueType.DICTIONARY, obj_value={"a": 22, "b": 33})
    ...
    def test_json_value_subtypes(self):
        json_value_interval = JsonValue(value_type=ValueType.INTERVAL, json_value=1970, obj_value=OInterval(300))
        json_value_date = JsonValue(value_type=ValueType.DATE, json_value=1970, obj_value=ODate(days_since_epoch=300))
        json_value_time = JsonValue(value_type=ValueType.TIME, json_value=1970, obj_value=OTime(millis_of_day=300))
    ...
    def test_json_value_boolean(self):
        json_value_false = JsonValue(value_type=ValueType.INT, bool_value=False, obj_value=123)
        ...
        json_value_true = JsonValue(value_type=ValueType.INT, bool_value=True, obj_value=123)
    ...
    def test_json_value_equals(self):
        byte = pack('h', 523)
        byte2 = pack('h', 123)
        json_value_byte = JsonValue(value_type=ValueType.BYTE, obj_value=byte, json_value=523)
        ...
        json_value_int = JsonValue(value_type=ValueType.INT, obj_value=123, json_value=123)
        ...
        json_value_long = JsonValue(value_type=ValueType.LONG, obj_value=99999999999999999999999999999,
        ...
        json_value_float = JsonValue(value_type=ValueType.FLOAT, obj_value=123.33, json_value=123.33)

...
class FieldPathParser ( Parser ):

    grammarFileName = "FieldPath.g4"
    ...
    def __init__(self, input, output=sys.stdout):
        super(FieldPathParser, self).__init__(input, output=output)
    ...
    class ParseContext(ParserRuleContext):
        ...
        def __init__(self, parser, parent=None, invokingState=-1):
            super(FieldPathParser.ParseContext, self).__init__(parent, invokingState)
            self.parser = parser
            self.fp = None
            self._field_segment = None # Field_segmentContext

        def field_segment(self):
            return self.getTypedRuleContext(FieldPathParser.Field_segmentContext,0)


        def getRuleIndex(self):
            return FieldPathParser.RULE_parse
    ...
    def parse(self):
        ...
        localctx = FieldPathParser.ParseContext(self, self._ctx, self.state)
    ...
    class Field_segmentContext(ParserRuleContext):
        ...
        def __init__(self, parser, parent=None, invokingState=-1):
            super(FieldPathParser.Field_segmentContext, self).__init__(parent, invokingState)
            self.parser = parser
            self.seg = None
            self.s1 = None # Name_segmentContext

        def name_segment(self):
            return self.getTypedRuleContext(FieldPathParser.Name_segmentContext,0)


        def getRuleIndex(self):
            return FieldPathParser.RULE_field_segment
    ...
    def field_segment(self):
        ...
        localctx = FieldPathParser.Field_segmentContext(self, self._ctx, self.state)
    ...
    class Name_segmentContext(ParserRuleContext):
        ...
        def __init__(self, parser, parent=None, invokingState=-1):
            super(FieldPathParser.Name_segmentContext, self).__init__(parent, invokingState)
            self.parser = parser
            self.seg = None
        ...
        def QuotedIdentifier(self):
            return self.getToken(FieldPathParser.QuotedIdentifier, 0)

        def index_segment(self):
            return self.getTypedRuleContext(FieldPathParser.Index_segmentContext,0)


        def Period(self):
            return self.getToken(FieldPathParser.Period, 0)
        ...
        def Identifier(self):
            return self.getToken(FieldPathParser.Identifier, 0)

        def Integer(self):
            return self.getToken(FieldPathParser.Integer, 0)

        def getRuleIndex(self):
            return FieldPathParser.RULE_name_segment
    ...
    def name_segment(self):
        ...
        localctx = FieldPathParser.Name_segmentContext(self, self._ctx, self.state)
        self.enterRule(localctx, 4, self.RULE_name_segment)
        try:
            self.state = 35
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [FieldPathParser.QuotedIdentifier]:
                self.enterOuterAlt(localctx, 1)
                self.state = 14
                localctx._QuotedIdentifier = self.match(FieldPathParser.QuotedIdentifier)
                self.state = 18
                self._errHandler.sync(self)
                token = self._input.LA(1)
                if token in [FieldPathParser.Period]:
                    self.state = 15
                    self.match(FieldPathParser.Period)
                    self.state = 16
                    localctx.s1 = self.field_segment()
                    pass
                elif token in [FieldPathParser.OBracket]:
                    self.state = 17
                    localctx.s2 = self.index_segment()
                    pass
                elif token in [FieldPathParser.EOF]:
                    pass
                else:
                    pass
                ...
                pass
            elif token in [FieldPathParser.Identifier]:
                self.enterOuterAlt(localctx, 2)
                self.state = 21
                localctx._Identifier = self.match(FieldPathParser.Identifier)
                self.state = 25
                self._errHandler.sync(self)
                token = self._input.LA(1)
                if token in [FieldPathParser.Period]:
                ...
                pass
            elif token in [FieldPathParser.Integer]:
                self.enterOuterAlt(localctx, 3)
                self.state = 28
                localctx._Integer = self.match(FieldPathParser.Integer)
                self.state = 32
                self._errHandler.sync(self)
                token = self._input.LA(1)
                if token in [FieldPathParser.Period]:
    ...
    class Index_segmentContext(ParserRuleContext):
        ...
        def __init__(self, parser, parent=None, invokingState=-1):
            super(FieldPathParser.Index_segmentContext, self).__init__(parent, invokingState)
            self.parser = parser
            self.seg = None
            self._Integer = None # Token
            self.s1 = None # Field_segmentContext
        ...
        def OBracket(self):
            return self.getToken(FieldPathParser.OBracket, 0)

        def CBracket(self):
            return self.getToken(FieldPathParser.CBracket, 0)
        ...
        def getRuleIndex(self):
            return FieldPathParser.RULE_index_segment
    ...
    def index_segment(self):
        ...
        localctx = FieldPathParser.Index_segmentContext(self, self._ctx, self.state)
        self.enterRule(localctx, 6, self.RULE_index_segment)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 37
            self.match(FieldPathParser.OBracket)
            self.state = 39
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if _la==FieldPathParser.Integer:
                self.state = 38
                localctx._Integer = self.match(FieldPathParser.Integer)


            self.state = 41
            self.match(FieldPathParser.CBracket)
            self.state = 45
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [FieldPathParser.Period]:

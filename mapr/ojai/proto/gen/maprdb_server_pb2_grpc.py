...
class MapRDbServerStub(object):
  ...
  def __init__(self, channel):
    ...
    self.CreateTable = channel.unary_unary(
        '/com.mapr.maprdb.grpc.MapRDbServer/CreateTable',
    ...
    self.DeleteTable = channel.unary_unary(
        '/com.mapr.maprdb.grpc.MapRDbServer/DeleteTable',
    ...
    self.TableExists = channel.unary_unary(
        '/com.mapr.maprdb.grpc.MapRDbServer/TableExists',
    ...
    self.InsertOrReplace = channel.unary_unary(
        '/com.mapr.maprdb.grpc.MapRDbServer/InsertOrReplace',
    ...
    self.FindById = channel.unary_unary(
        '/com.mapr.maprdb.grpc.MapRDbServer/FindById',
...
def add_MapRDbServerServicer_to_server(servicer, server):
  ...
  generic_handler = grpc.method_handlers_generic_handler(
      'com.mapr.maprdb.grpc.MapRDbServer', rpc_method_handlers)

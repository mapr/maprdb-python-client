...
class QueryCondition:
    ...
    @abstractmethod
    def condition(self, condition_to_add):
    ...
    def exists(self, path):
        ...
        :param path: the path to test. Type may be str, FieldPath.
        :return self for chained invocation."""
        raise NotImplementedError("This should have been implemented.")
    ...
    @abstractmethod
    def _in(self, path, list_of_value):
    ...
    @abstractmethod
    def _not_in(self, path, list_of_value):
        """ Adds a condition that tests if the Value at the specified
    ...
    @abstractmethod
    def type_of(self, path, value_type):
        """Adds a condition that tests if the Value at the specified
    ...
    @abstractmethod
    def not_type_of(self, path, value_type):
        """Adds a condition that tests if the Value at the specified
    ...
    @abstractmethod
    def not_matches(self, path, regex):
        """Adds a condition that tests if the Value at the specified
    ...
    @abstractmethod
    def like(self, path, like_expression, escape_char=None):
        """Adds a condition that tests if the Value at the specified
    ...
    @abstractmethod
    def not_like(self, path, like_expression, escape_char=None):
        """Adds a condition that tests if the Value at the specified

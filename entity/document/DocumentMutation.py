...
class DocumentMutation:
    ...
    def set(self, path, value=None):
        ...
        :param path: path of the field that needs to be updated. Type may be FieldPath, str.
    ...
    @abstractmethod
    def set_or_replace(self, path, value=None):
        """Sets or replaces the field at the given FieldPath to Value
        :param path: FieldPath in the document that needs to be updated. Type may be FieldPath, str.
    ...
    @abstractmethod
    def append(self, path, value, offset=None, length=None):
        """Appends the given value to an existing value at the given path.
        :param path: the FieldPath to apply this append operation. Type may be FieldPath, str.
        :param value: the value to append. Type may be bytearray, dictionary, list, str.
    ...
    def merge(self, path, value):
        ...
        :param path: FieldPath to apply this merge operation. Type may be FieldPath, str.
    ...
    def increment(self, path, inc):
        ...
        :param path: FieldPath to apply this increment operation. Type may be FieldPath, str.
    ...
    def decrement(self, path, dec):
        ...
        :param path: field name in dot separated notation. Type may be FieldType, str.
    ...
    def delete(self, path):
        ...
        :param path: he FieldPath to delete
        :return self for chained invocation"""
        raise NotImplementedError("Should have implemented this")

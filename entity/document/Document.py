...
class Document:
    ...
    @abstractmethod
    def set(self, field_path, value=None, off=None, length=None):
        ...
        .. warnings:: decimal and OInterval not supported in MapR-DB yet.
        The implementation of the method should throw "Unsupported error"""
